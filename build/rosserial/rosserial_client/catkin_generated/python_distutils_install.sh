...
echo_and_run cd "/home/drone/Arduino/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/drone/Arduino/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/drone/Arduino/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
