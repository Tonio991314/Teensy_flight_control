...
echo_and_run cd "/home/drone/Arduino/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/drone/Arduino/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/drone/Arduino/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
