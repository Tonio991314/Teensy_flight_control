...
echo_and_run cd "/home/drone/Arduino/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/drone/Arduino/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/drone/Arduino/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
