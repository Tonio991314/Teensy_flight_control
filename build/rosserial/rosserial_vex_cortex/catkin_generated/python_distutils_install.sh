...
echo_and_run cd "/home/drone/Arduino/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/drone/Arduino/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/drone/Arduino/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
