...
echo_and_run cd "/home/drone/Arduino/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/drone/Arduino/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/drone/Arduino/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
